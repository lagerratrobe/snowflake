...
-- 1.2.3   Name the database VIPER_DB.
...
-- 1.3.2   Click [Create] and create a table named VIPER_TBL.
...
ALTER USER VIPER
    ...
    DEFAULT_NAMESPACE=VIPER_DB.PUBLIC
    DEFAULT_WAREHOUSE=VIPER_WH;
...
--         set, select the training_role and VIPER_wh in the context section.
